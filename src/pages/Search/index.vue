  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector @trademarkInfoSearch="trademarkInfoSearch"/>
        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active :syntheseActive}"  @click="changeOrder('1')">
                  <a  v-show="syntheseSort">综合⬇</a>
                  <a  v-show="!syntheseSort">综合⬆</a>
                </li>
                <li :class="{ active :priceActive}" @click="changeOrder('2')">
                  <a  v-show="priceSort" >价格⬇</a>
                  <a  v-show="!priceSort">价格⬆</a>
                </li>
              </ul>
            </div>
...
export default {
  ...
  methods: {
    ...
    removeKeyword() {
      ...
      //清理输入框的值
      this.$bus.$emit('keywordClear')
    },
    removeTradeMark() {
      this.searchParams.trademark=''
      this.getSearchData()
    },
    trademarkInfoSearch(trademark){
      this.searchParams.trademark=`${trademark.tmId}:${trademark.tmName}`
      this.getSearchData()
    },
    changeOrder(value){
      //初始为降序
      let flagSort=this.searchParams.order.split(':')[1]
      let newSort=''
      //综合
      if(value==='1'){
          newSort=flagSort==='desc'?'1:asc':'1:desc'
      }else {
        newSort=flagSort==='desc'?'2:asc':'2:desc'
      }
