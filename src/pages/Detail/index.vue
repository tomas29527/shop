          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{active:value.isChecked==1}" v-for=" value in spuSaleAttr.spuSaleAttrValueList" :key="value.id"
                    @click="changeActive(value,spuSaleAttr.spuSaleAttrValueList)">{{value.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
export default {
  ...
  methods: {
    //获取商品详情信息
    async getGoodsInfo() {
      let result = await reqGoodsInfo(this.$route.params.skuId)
